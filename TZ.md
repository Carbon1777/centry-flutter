...
Шаг 5 — Полировка
Проверить адреса всех мест если встречаюся адреса с "Этаж", "Квартира", "Кв", "Домофон" После номера дома. то это подчищаем. То есть адрес может содержать в себе город, район, улица, корпус, строение, номер дома. Все что более подробно что-то указывает убираем.
